...
namespace Common.BuildPipeline
{
    public class Arguments
    {
        ...
        public void SetStaticPropertiesFromFields<T>(object fromObjectFields, bool checkContainsArgs = true)
            where T : class
        {
            ...
            var fields = valueType.GetFields(BindingFlags.Instance | BindingFlags.GetField | BindingFlags.Public)
                .ToDictionary(f => f.Name);

            var properties =
                staticType.GetProperties(BindingFlags.Static | BindingFlags.SetProperty | BindingFlags.Public);
        ...
        public int GetAsInt(string key)
        {
            ...
            Assert.IsTrue(isOk, BuilderUtils.GetMessageNotValidArgs(key, this, new[] {"int (example: 10)"}));
            return value;
        }
        ...
        public float GetAsFloat(string key)
        {
            ...
            Assert.IsTrue(isOk, BuilderUtils.GetMessageNotValidArgs(key, this, new[] {"float (example: 1.4)"}));
            return value;
        }
