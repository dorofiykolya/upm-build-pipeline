...
namespace Common.BuildPipeline
{
    public class BuilderArguments
    {
        ...
        [Key(false, typeof(ScriptingImplementation), Description =
            "Sets the scripting framework for a BuildTargetPlatformGroup.")]
        public const string ScriptingBackend = "scriptingBackend";

        [Key(false, Description = "Show Unity SplashScreen")]
        public const string ShowUnitySplash = "showUnitySplash";

        [Key(false, Description = "force embed bundles, ignoring bundle configuration")]
        public const string EmbedBundles = "embedBundles";
        ...
        public class Android
        {
            ...
            [Key(false, typeof(AndroidPreferredInstallLocation), Description =
            ...
            [Key(false, Description =
                "Publish the build as a game rather than a regular application. This option affects devices running Android 5.0 Lollipop and later")]
            ...
            [Key(false, typeof(AndroidArchitecture), Description =
                "A set of CPU architectures for the Android build target. (enum flag, example use: \"targetArchitectures ARMv7,ARM64\")")]
        ...
        public class IOS
        {
            ...
            [Key(false, typeof(iOSAppInBackgroundBehavior), Description =
                "Application behavior when entering background.")]
            public const string AppInBackgroundBehavior = "appInBackgroundBehavior";

            [Key(false, typeof(iOSBackgroundMode), Description =
                "Supported background execution modes (when appInBackgroundBehavior is set to '--appInBackgroundBehavior Custom').")]
            ...
            [Key(false, typeof(SystemGestureDeferMode), Description =
            ...
            [Key(false, RequiredValue = true,
                Description =
                    "A provisioning profile Universally Unique Identifier (UUID) that Xcode will use to build your iOS app in Manual Signing mode.")]
            public const string IOSManualProvisioningProfileID = "iOSManualProvisioningProfileID";

            [Key(false, typeof(ProvisioningProfileType), Description =
            ...
            [Key(false, Description =
                "Set this property to true for Xcode to attempt to automatically sign your app based on your appleDeveloperTeamID.")]
            ...
            [Key(false, RequiredValue = true,
                Description = "Describes the reason for access to the user's location data.")]
            public const string LocationUsageDescription = "locationUsageDescription";

            [Key(false, RequiredValue = true,
                Description = "Describes the reason for access to the user's microphone.")]
            public const string MicrophoneUsageDescription = "microphoneUsageDescription";

            [Key(false, RequiredValue = true,
                Description =
                    "A provisioning profile Universally Unique Identifier (UUID) that Xcode will use to build your tvOS app in Manual Signing mode.")]
            ...
            [Key(false, Description =
                "RequiresFullScreen maps to Apple's plist build setting UIRequiresFullScreen, which is used to opt out of being eligible to participate in Slide Over and Split View for iOS 9.0 multitasking.")]
            ...
            [Key(false, typeof(iOSShowActivityIndicatorOnLoading), Description =
            ...
            [Key(false, typeof(iOSLaunchScreenType), Description =
        ...
        {
            [Key(false, RequiredValue = true,
                Description = "Default horizontal dimension of stand-alone player window.")]
            public const string DefaultScreenWidth = "defaultScreenWidth";

            [Key(false, RequiredValue = true, Description = "Default vertical dimension of stand-alone player window.")]
            public const string DefaultScreenHeight = "defaultScreenHeight";

            [Key(false, typeof(FullScreenMode), Description =
